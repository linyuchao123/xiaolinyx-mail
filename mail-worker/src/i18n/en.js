const en = {
	...
	reservedEmailAddress: 'This address is reserved. Choose another name',
	registrationIpRequired: 'Could not identify your network. Try again later',
	registrationRateLimited: 'Too many registrations from this network in the past 24 hours',
	adminBootstrapRequired: 'The administrator address requires the initialization secret',
	publicRegistrationRequiresTurnstile: 'Configure Turnstile site and secret keys and enable registration verification before opening registration',
	publicAttachmentDomainDisabled: 'Attachments in a multi-user mailbox require sign-in; a public attachment domain is disabled',
	...
	invalidRecipients: 'Recipients must be 1 to 10 valid email addresses',
	dailyProviderLimit: 'The site-wide daily outbound quota is exhausted',
