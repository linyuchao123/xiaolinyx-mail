const zh = {
	...
	regDisabled: '注册功能已关闭',
	reservedEmailAddress: '此邮箱名为系统保留地址，请换一个',
	registrationIpRequired: '无法识别注册来源，请稍后重试',
	registrationRateLimited: '此网络 24 小时内注册次数已达上限',
	adminBootstrapRequired: '管理员邮箱必须使用初始化密钥创建',
	publicRegistrationRequiresTurnstile: '开放注册前，请配置 Turnstile Site Key 和 Secret Key，并启用注册验证',
	publicAttachmentDomainDisabled: '多用户邮箱的附件必须通过登录鉴权，不能启用公开附件域名',
	emptyEmail: '邮箱不能为空',
	...
	invalidRecipients: '收件人必须是 1 至 10 个有效邮箱地址',
	dailyProviderLimit: '全站今日站外发信额度已用完，请明天再试',
